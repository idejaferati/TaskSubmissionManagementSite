                    ...
                    <div class="card">
                        <div class="card-body">
                            <img src="../photo/uni-logo.jpg" class="card-img-top" alt="foto" height=250px><br><br>
                                 ...
                                 <form action="modifikolende.php" method="post" id="modifiko">
    
                                 <input type="hidden" name="lendaid" value=" <?php echo $row['id_l'] ?>">
                                 <input type="submit" name="modifikolende_btn" value="Modifiko lenden"></form>
